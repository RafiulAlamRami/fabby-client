...
const Footer = () => {
    return (
        <div>
            <footer className="footer footer-center p-10 bg-primary text-primary-content flex justify-around">
                <aside>
			...
			<div className="space-y-4">
				<p className="flex items-center">
					...
					<span>Lake City,Dhaka-1200</span>
				</p>
				<p className="flex items-center">
