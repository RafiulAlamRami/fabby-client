                        ...
                        <form className="card-body" onSubmit={handleSubmit(handleForm)}>
                            ...
                            <div className="form-control">
                                ...
                                {...register("password", {
                                    ...
                                    pattern:{
                                        value:/(?=.*[A-Z])(?=.*[a-z])/,
                                        message:'Must be include at least 1 Uppercase and 1 lowercase carechter'
                                    }
                                  })}
                                />
                                <span className='absolute right-[3.5rem] bottom-[10rem]' onClick={()=>setShowPass(!showPass)}>{showPass?<IoIosEye />:<IoIosEyeOff></IoIosEyeOff>}</span>
                                <div>
